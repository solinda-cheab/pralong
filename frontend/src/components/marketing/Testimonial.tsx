...
export default function UserInsightSection({
  videoSrc = "./public/Pralong.com.mp4", // Replace with your video path
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            ...
            <div className="relative w-full max-w-[320px] aspect-[9/19.5] rounded-[48px] bg-[#1a1a1a] p-3 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] border-4 border-[#2b2b2b]">
              ...
              <div className="absolute -left-[7px] top-38 h-12 w-[3px] rounded-l-md bg-[#333]" />
              <div className="absolute -left-[7px] top-54 h-12 w-[3px] rounded-l-md bg-[#333]" />
